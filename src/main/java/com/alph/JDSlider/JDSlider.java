 ...
 * @since Trick 10
 */
public class JDSlider extends JSlider implements ChangeListener {
	...
	public void stateChanged(ChangeEvent e) {
		JDSlider slider = (JDSlider) e.getSource();
	...
	class DoubleJSliderUI extends BasicSliderUI implements MouseMotionListener, MouseListener {
		 ...
		 * 
		 * @param slider
		 *            The specified {@link DoubleJSlider}.
		 */
		public DoubleJSliderUI(JDSlider slider) {
			super(slider);
